...
(function () {
  ...
  var MARKS = {
    'ss-jersey': {
      A: { v: [30, 33, 68], chip: [25, 56] },
      B: { h: [46, 33, 64], chip: [28, 46] },
      C: { h: [34, 38, 60], chip: [64, 34] },
      D: { l: [64, 38, 71, 50], chip: [76, 42] },
      E: { h: [51, 64, 72], chip: [77, 51] }
    },
    'ls-jersey': {
      A: { v: [30, 32, 66], chip: [25, 55] },
      B: { h: [45, 33, 63], chip: [28, 45] },
      C: { h: [32, 37, 60], chip: [64, 32] },
      D: { l: [62, 37, 67, 68], chip: [70, 52] },
